...
class Cube:
    ...
    def plot(self,iv=None,v=None,colorbar=True,plot_beam=True,color_scale=None,fmin=None,fmax=None,limit=None,limits=None,moment=None,Tb=False,cmap=None,v0=None,dv=None,ax=None,no_ylabel=False,no_xlabel=False,no_vlabel=False,title=None,alpha=1.0,resample=0, bmaj=None, bmin=None, bpa=None, taper=None,colorbar_label=True,M0_threshold=None,vlabel_position="bottom",shift_dx=0,shift_dy=0):
        ...
        image = ax.imshow(im, norm=norm, extent=self.extent - np.asarray([shift_dx,shift_dx,shift_dy,shift_dy]),
